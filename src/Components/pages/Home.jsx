        ...
        <div className="column">
          <div className="box">
            ...
            <p className="subtitle has-text-centered">
              Stocks that increase in value over the course of the trading day are described as gainers. Those that increase the most in relation to their opening price are called percentage gainers, or percentage winners. Those that go up the greatest number of points are called net gainers.
    </p>
          </div>
        </div>
        <div className="column">
